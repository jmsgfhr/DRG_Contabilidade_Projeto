...
function add_styles_and_scripts() {
    ...
    wp_enqueue_style( 'style1', get_template_directory_uri('style') . '/page-servicos.css', array());
    wp_enqueue_style( 'style2', get_template_directory_uri('style','style1') . '/style.css', array('style'));
